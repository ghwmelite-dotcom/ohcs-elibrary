...
twoFactorRoutes.get('/status', async (c) => {
  ...
  try {
    ...
    return c.json({ error: 'Server Error', message: 'An error occurred' }, 500);
  }
});
...
twoFactorRoutes.post('/check-device', async (c) => {
  ...
  try {
    ...
    console.error('2FA check-device error:', error);
    return c.json({ error: 'Server Error', message: 'An error occurred' }, 500);
  }
});
...
twoFactorRoutes.post('/backup-codes/regenerate', async (c) => {
  ...
  try {
    ...
    console.error('2FA backup-codes regenerate error:', error);
    return c.json({ error: 'Server Error', message: 'An error occurred' }, 500);
  }
});
...
twoFactorRoutes.get('/devices', async (c) => {
  ...
  try {
    ...
    console.error('2FA devices list error:', error);
    return c.json({ error: 'Server Error', message: 'An error occurred' }, 500);
  }
});
...
twoFactorRoutes.delete('/devices/:id', async (c) => {
  ...
  try {
    ...
    console.error('2FA device delete error:', error);
    return c.json({ error: 'Server Error', message: 'An error occurred' }, 500);
  }
});
...
twoFactorRoutes.delete('/devices', async (c) => {
  ...
  try {
    ...
    console.error('2FA devices delete-all error:', error);
    return c.json({ error: 'Server Error', message: 'An error occurred' }, 500);
  }
});
