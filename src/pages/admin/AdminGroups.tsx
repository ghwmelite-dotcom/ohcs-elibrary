...
export default function AdminGroups() {
  ...
  const groups: Group[] = [
    {
      ...
      description: 'A community for IT professionals across all MDAs to share knowledge and best practices',
      type: 'official',
      category: 'Technology',
      ...
      postsPerWeek: 45,
      status: 'active',
      owner: { name: 'Kwame Asante', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150', role: 'IT Director' },
      admins: [
        { name: 'Ama Serwaa' },
        { name: 'Kofi Mensah' },
      ],
    ...
    },
    {
      ...
      description: 'Discussing and analyzing government policies and their implementation',
      type: 'closed',
      category: 'Research',
      ...
      postsPerWeek: 12,
      status: 'active',
      owner: { name: 'Prof. Ama Sarpong', role: 'Policy Analyst' },
      admins: [],
    ...
    },
    {
      ...
      description: 'Networking and mentorship group for new civil servants joining the service',
      type: 'open',
      category: 'Networking',
      ...
      postsPerWeek: 78,
      status: 'active',
      owner: { name: 'Kofi Mensah', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150', role: 'HR Officer' },
      admins: [
        { name: 'Grace Appiah' },
      ],
    ...
    {
      id: '4',
      name: 'Finance & Budget Officers',
      description: 'Official group for finance professionals managing public budgets',
      type: 'official',
      category: 'Finance',
      ...
      postsPerWeek: 23,
      status: 'active',
      owner: { name: 'Abena Owusu', role: 'Chief Accountant' },
      admins: [],
    ...
    },
    {
      ...
      description: 'Community for Ghana Health Service employees and healthcare workers',
      type: 'closed',
      category: 'Healthcare',
      ...
      postsPerWeek: 34,
      status: 'active',
      owner: { name: 'Dr. Yaa Mensah', avatar: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=150', role: 'Medical Director' },
      admins: [
        { name: 'Nurse Akua' },
      ],
    ...
    {
      id: '6',
      name: 'Civil Service Book Club',
      description: 'Monthly book discussions on leadership, governance, and personal development',
      type: 'private',
      category: 'Education',
      ...
      postsPerWeek: 8,
      status: 'active',
      owner: { name: 'Samuel Adjei', role: 'Training Officer' },
      admins: [],
  ...
  const memberRequests: MemberRequest[] = [
    {
      id: '1',
      user: { name: 'Emmanuel Owusu', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=50', role: 'IT Officer', mda: 'Ministry of Finance' },
      group: 'IT Officers Network',
      groupId: '1',
      requestedAt: new Date(Date.now() - 3600000),
      message: 'I would like to join to collaborate with fellow IT professionals.',
      status: 'pending',
    },
    {
      id: '2',
      user: { name: 'Akosua Mensah', role: 'Junior Officer', mda: 'Ghana Revenue Authority' },
      group: 'Young Civil Servants',
      groupId: '3',
    ...
    {
      id: '3',
      user: { name: 'Michael Asamoah', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=50', role: 'Research Analyst', mda: 'NDPC' },
      group: 'Policy Research Group',
      groupId: '2',
      requestedAt: new Date(Date.now() - 86400000),
      message: 'My research focuses on policy implementation effectiveness.',
      status: 'pending',
    },
  ];
  ...
  const flaggedGroups: FlaggedGroup[] = [
    {
      id: '1',
      groupName: 'Unofficial Trading Group',
      groupId: 'x1',
      reason: 'Commercial activity',
      reportedBy: 'Admin Team',
      reportedAt: new Date(Date.now() - 86400000 * 2),
      description: 'This group appears to be conducting unauthorized commercial activities within the platform.',
      status: 'pending',
    },
    {
      id: '2',
      groupName: 'Political Discussion Forum',
      groupId: 'x2',
      reason: 'Policy violation',
      reportedBy: 'Multiple users',
      reportedAt: new Date(Date.now() - 86400000 * 3),
      description: 'Group discussions have deviated into partisan political debates, violating platform guidelines.',
      status: 'pending',
    },
  ];

  const stats = [
    { label: 'Total Groups', value: '156', change: '+8', icon: Users, color: 'green' },
    { label: 'Active Members', value: '2,345', change: '+12%', icon: UserPlus, color: 'blue' },
    { label: 'Posts This Week', value: '892', change: '+15%', icon: MessageSquare, color: 'gold' },
    { label: 'Official Groups', value: '23', change: '+2', icon: Shield, color: 'purple' },
  ];
