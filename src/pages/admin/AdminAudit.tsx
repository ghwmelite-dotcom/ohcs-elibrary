...
export default function AdminAudit() {
  ...
  const logs: AuditLog[] = [
    {
      ...
      user: { id: '1', name: 'Kwame Asante', email: 'kwame@mof.gov.gh', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150', role: 'Admin' },
      ipAddress: '41.215.160.1',
      location: 'Accra, Ghana',
      device: { type: 'desktop', browser: 'Chrome 120.0', os: 'Windows 11' },
      status: 'success',
    ...
    },
    {
      ...
      user: { id: '2', name: 'Ama Serwaa', email: 'ama@moh.gov.gh', role: 'Librarian' },
      ipAddress: '41.215.161.45',
      location: 'Kumasi, Ghana',
      device: { type: 'desktop', browser: 'Firefox 121.0', os: 'macOS Sonoma' },
      status: 'success',
      details: 'Uploaded "Ghana Health Policy 2024.pdf" (2.4 MB) to Public Documents',
      metadata: { fileSize: '2.4 MB', category: 'Health Policy' },
    ...
    },
    {
      ...
      status: 'failure',
      details: 'Invalid credentials - Account locked after 5 consecutive failed attempts. Suspicious activity detected from foreign IP.',
    ...
    },
    {
      ...
      metadata: { previousRole: 'User', newRole: 'Moderator', targetUser: 'Kofi Mensah' },
    ...
    },
    {
      ...
      ipAddress: '41.215.160.1',
      location: 'Accra, Ghana',
      device: { type: 'mobile', browser: 'Safari Mobile', os: 'iOS 17' },
      status: 'warning',
      details: 'Enabled maintenance mode - All non-admin users will be unable to access the platform',
    ...
    },
    {
      ...
      ipAddress: '41.215.161.45',
      location: 'Kumasi, Ghana',
      device: { type: 'tablet', browser: 'Chrome 120.0', os: 'iPadOS 17' },
      status: 'success',
      details: 'Permanently deleted "Draft_Policy_v1.pdf" from Archived Documents',
    ...
    },
    {
      ...
      actionType: 'export',
      resource: 'Documents',
      user: { id: '4', name: 'Yaw Boateng', email: 'yaw@ohcs.gov.gh', role: 'Director' },
      ipAddress: '41.215.162.88',
      location: 'Accra, Ghana',
      device: { type: 'desktop', browser: 'Edge 120.0', os: 'Windows 11' },
      status: 'success',
      details: 'Exported 45 documents as ZIP archive (156 MB)',
      metadata: { documentCount: '45', archiveSize: '156 MB' },
    ...
    },
    {
      ...
      device: { type: 'desktop', browser: 'Chrome 120.0', os: 'Windows 11' },
      status: 'success',
      details: 'Created new user account for Efua Darko (efua@moe.gov.gh)',
      metadata: { newUserEmail: 'efua@moe.gov.gh', assignedRole: 'User', mda: 'Ministry of Education' },
  ...
  const activityData = [12, 45, 32, 67, 89, 54, 78, 91, 65, 43, 78, 56, 89, 67, 45, 78, 90, 67, 54, 87, 65, 43, 56, 78];
