    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 text-surface-700 dark:text-surface-300 bg-white dark:bg-surface-800 border border-surface-300 dark:border-surface-600 rounded-lg hover:bg-surface-50 dark:hover:bg-surface-700 transition-colors disabled:opacity-50"
        >
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-surface-800 rounded-xl p-5 shadow-sm border border-surface-100 dark:border-surface-700">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold text-surface-900 dark:text-white">Literature</h3>
          </div>
        ...
        <div className="bg-white dark:bg-surface-800 rounded-xl p-5 shadow-sm border border-surface-100 dark:border-surface-700">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold text-surface-900 dark:text-white">Insights</h3>
          </div>
          <p className="text-3xl font-bold text-surface-900 dark:text-white">
        ...
        <div className="bg-white dark:bg-surface-800 rounded-xl p-5 shadow-sm border border-surface-100 dark:border-surface-700">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold text-surface-900 dark:text-white">Research Briefs</h3>
          </div>
          <p className="text-3xl font-bold text-surface-900 dark:text-white">
      ...
      {/* Search & Filters */}
      <div className="bg-white dark:bg-surface-800 rounded-xl p-4 shadow-sm border border-surface-100 dark:border-surface-700">
        <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border border-surface-300 dark:border-surface-600 rounded-lg bg-white dark:bg-surface-900 text-surface-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            />
          </div>
          ...
          <div className="flex gap-3">
            <div className="relative">
              <select
                ...
                className="appearance-none pl-4 pr-8 py-2.5 border border-surface-300 dark:border-surface-600 rounded-lg bg-white dark:bg-surface-900 text-surface-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm"
              >
            ...
            <tbody className="divide-y divide-surface-100 dark:divide-surface-700">
              {projectsLoading ? (
                [...Array(5)].map((_, i) => (
                  <tr key={i}>
                    <td colSpan={7} className="px-6 py-4">
                      <div className="h-12 bg-surface-100 dark:bg-surface-700 rounded animate-pulse" />
                    </td>
                  </tr>
                ))
              ) : projects.length === 0 ? (
                ...
                projects.map((project) => {
                  ...
                  return (
                    <tr key={project.id} className="hover:bg-surface-50 dark:hover:bg-surface-700/50 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-medium text-surface-900 dark:text-white max-w-xs truncate">
                              {project.title}
                            </div>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <div className="flex-1 h-2 bg-surface-200 dark:bg-surface-700 rounded-full max-w-[100px]">
                            <div
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <a
                            ...
                            className="p-2 text-surface-400 dark:text-surface-500 hover:text-primary-500 transition-colors"
                            title="View Project"
                          >
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-surface-100 dark:border-surface-700">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-1.5 border border-surface-300 dark:border-surface-600 rounded-lg text-sm disabled:opacity-50 disabled:cursor-not-allowed hover:bg-surface-50 dark:hover:bg-surface-700 transition-colors"
              >
                Previous
              </button>
              <button
